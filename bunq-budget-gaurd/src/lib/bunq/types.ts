...
// Payment Account Details Interfaces
export interface PaymentAccountDetailsResponse {
  Response: PaymentAccountDetailsItem[];
}

export interface PaymentAccountDetailsItem {
...
export interface MonetaryAccountBank {
  ...
  connected_cards: any[];
  budget: any[];
  all_access: MonetaryAccountAccessItem[];
  overdraft_limit: MonetaryAmount;
...
export interface AccountAvatarImage {
  ...
  width: number;
  content_type: string;
  urls: AccountAvatarImageUrl[];
}

export interface AccountAvatarImageUrl {
  type: string;
  url: string;
}
...
export interface MonetaryAccountProfile {
  profile_fill?: {
    status: string;
    balance_preferred: MonetaryAmount;
    balance_threshold_low: MonetaryAmount;
  };
  profile_drain: null;
  profile_action_required: string;
  profile_amount_required: MonetaryAmount;
}
...
export interface MonetaryAccountAccessItem {
